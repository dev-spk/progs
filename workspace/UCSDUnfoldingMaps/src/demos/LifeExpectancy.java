...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
		...
		// The unfoldingMap constructor accepts the current lifeExpectancy instance object, 
		// start & end coordinates of the map printed on the canvas, and an object of the google Map Provider 
		map = new UnfoldingMap(this, 50, 50, 1750, 950, new Google.GoogleMapProvider());
	...
	private void shadeCountries() {
		for (Marker marker : countryMarkers) {
			...
			if (lifeExpMap.containsKey(countryId)) {
				...
				int colorLevel = (int) map(lifeExp, 40, 90, 10, 255); // what is map? - a constructor?, a method ? 
